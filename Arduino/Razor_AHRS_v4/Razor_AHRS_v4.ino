...
#define OUTPUT__MODE_SENSORS_CALIB_NEW 5
...
#define ACCEL_X_MIN ((float) -16808.00)
#define ACCEL_X_MAX ((float) 16352.00)
#define ACCEL_Y_MIN ((float) -16336.00)
#define ACCEL_Y_MAX ((float) 16984.00)
#define ACCEL_Z_MIN ((float) -16152.00)
#define ACCEL_Z_MAX ((float) 17480.00)

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"

#define MAGN_X_MIN ((float) -240)
#define MAGN_X_MAX ((float) 426)
#define MAGN_Y_MIN ((float) -73)
#define MAGN_Y_MAX ((float) 581)
#define MAGN_Z_MIN ((float) -283)
#define MAGN_Z_MAX ((float) 421)
...
#define GYRO_AVERAGE_OFFSET_X ((float) 6.85)
#define GYRO_AVERAGE_OFFSET_Y ((float) 2.77)
#define GYRO_AVERAGE_OFFSET_Z ((float) 20.15)
    ...
    if (SerialPort.read() == '#') // Start of new control message
    {
      ...
      else if (command == 'o') // Set _o_utput mode
      {
        ...
        else if (output_param == 's') // Output _s_ensor values
        {
          ...
          else if (values_param == 'n')  // Output _c_alibrated sensor values
            output_mode = OUTPUT__MODE_SENSORS_CALIB_NEW;
